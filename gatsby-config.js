...
module.exports = {
    siteMetadata: {
        title: `Packem - A precompiled ES module bundler`,
        siteUrl: process.env.SITE_URL || `https://packem.github.io/`,
        description: `Packem is a compiled ES module bundler and linker.`,
    },
    plugins: plugins,
}
