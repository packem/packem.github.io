...
const getGitHubLink = (absoluteFilePath) => {
    ...
    const gitHubRepos = [
        ...
        //     url: `https://github.com/packem.github.io/docs-api/blob/v0.11/`,
        // },
        // {
        //     regex: /^(?:\S*\/content\/api\/v2\/)(\S*)/i,
        //     url: `https://github.com/packem.github.io/docs-api/blob/master/`,
        // },
        {
            regex: /^(?:\S*\/content\/)(\S*)/i,
            url: `https://github.com/packem/packem.github.io/blob/master/content/`,
        },
    ]
