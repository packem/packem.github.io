...
const Footer = () => (
    <footer className="pb-vw3 bt b--whitegrey">
        ...
        <section className={`${Spirit.page.xl}`}>
            ...
            <div className="bt b--whitegrey flex justify-between items-center pt4">
                <ul className="flex list pa0 ma0 items-center">
                    ...
                    <li className={`${listItemClass} dn db-l`}><a href="https://gitter.im/packem_bundler/community" className={linkClass}>Gitter</a></li>
                    <li className={`${listItemClass} dn db-l`}><a href="https://twitter.com/packem_bundler" className={linkClass}>@packem_bundler</a></li>
                </ul>

                {/* <ul className="flex list pa0 ma0 items-center">
                    <li className={listItemClass}><a href="/" className="link pa2 midgrey hover-blue dib mr0">Ghost.org</a></li>
                </ul> */}
            </div>
